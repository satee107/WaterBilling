...
import com.example.ammulu.waterbilling.ValidateCollectionActivity;
...
public class CollectionValidateFragment extends Fragment {
    TextView cbid,cflatno,camount,cpaid;
    TableLayout t1;
    ProgressBar progressBar;

    SharedPreferences shre;
    public CollectionValidateFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_collection_validate, container, false);
