...
SharedPreferences shre;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_un_billed, container, false);
...
//        progressbar.setVisibility(View.VISIBLE);
        ...
        String url = API.getunreadingsUrl;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for(int i=0;i<arr.length();i++){
                                ...
                                String scanno = obj.getString("name");
                                String sflatno = obj.getString("flatno");
                                String sreading = obj.getString("phone");
                                String sreadingdate = obj.getString("meterno");
